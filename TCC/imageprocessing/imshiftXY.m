function varargout=imshiftXY(shiftVec, varargin)
...
%
%% Issues & Comments
% This functions utilizes the matlab IMFILTER function, which allowes mutlle image data
...
%
%% Example II- applying fractional shift to multle images simultaneosly
...
for iInput=1:length(varargin)
    inImg=varargin{iInput}; % get input
