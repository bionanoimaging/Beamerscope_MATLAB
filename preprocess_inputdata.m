...
imfolder = '/Users/Bene/Dropbox/Dokumente/Promotion/PROJECTS/Beamerscope/DatasetMLcrop/'; % MAC
...
% MAC
root_path = '/Users/Bene/Dropbox/Dokumente/Promotion/PROJECTS/Beamerscope/MATLAB/Beamerscope_MATLAB/';

cd(strcat(root_path, 'resultOptNN'));
...
% initliaze variable
complxObjectImages = zeros(finalSizeImage, finalSizeImage, nFiles);
...
for i=(1:nFiles)
    ...
    try
        ...
        if(1)
            currentImage = imresize(double(currentImage), [finalSizeImage finalSizeImage]);
        else
...
save('PreProcessedDataNN', 'complxObjectImages');
